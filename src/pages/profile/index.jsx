        ...
        <>
            ...
            <div>
                ...
                <div className="flex flex-col justify-items-start">
                    <div className="flex">
                        {user && currentUser.img_url ? <img className="h-36 w-36 rounded-full ring-8 ring-white sm:h-36 sm:w-36" src={currentUser.img_url} alt=""/> : <Avatar size={36}/>  }
                    </div>
                    <div className="flex flex-col">
                        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-4xl">
                            <span className="inline">{currentUser.name}</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap mt-4">
                            {
                                currentUser.technologies.map((technology, idx) => {
